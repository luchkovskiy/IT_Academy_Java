...
public class Main {
    public int catAge_forEach;
    public String catName_forEach;

    public Main(int age, String name) {
        catAge_forEach = age;
        catName_forEach = name;
    }

    public static void main(String[] args) {
        Cat.creatingCats_withWhile();
        Cat.creatingCats_withFor();
        Cat cat = new Cat(create_randomInt(), create_randomString());
        Cat.creatingCats_withDoWhile();
        Cat.creatingCats_withForEach();
    }

    public String toString() {
        return "Cat age is " + catAge_forEach + "\n Cat's name - " + catName_forEach;
    }
